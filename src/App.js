...
const App = () => {
  ...
  const loginWithFacebook = () => {
    window.FB.login(
      ...
      { scope: "pages_manage_ads,business_management, pages_read_engagement, pages_show_list, ads_management, leads_retrieval, pages_manage_metadata" } // Specify the permissions you need
    );
  };
